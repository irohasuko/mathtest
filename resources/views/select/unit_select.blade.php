...
@section('breadcrumbs', Breadcrumbs::render('unit_select'))
                    ...
                    <div class="card-body">
                        <div class="list-group">
                            @foreach($math1s as $math1)
                                <a href="{{route('question_select', $math1->id)}}" class="list-group-item list-group-item-action">{{$math1->name}}</a>
                            @endforeach
                        </div>
                    </div><!-- /.card-body -->
                  </div><!-- /.collapse -->
                    ...
                    <div class="card-body">
                      <div class="list-group">
                        @foreach($math2s as $math2)
                            <a href="{{route('question_select', $math2->id)}}" class="list-group-item list-group-item-action">{{$math2->name}}</a>
                        @endforeach
                    </div>
                    </div><!-- /.card-body -->
                  </div><!-- /.collapse -->
                    ...
                    <div class="card-body">
                      <div class="list-group">
                        @foreach($math3s as $math3)
                            <a href="{{route('question_select', $math3->id)}}" class="list-group-item list-group-item-action">{{$math3->name}}</a>
                        @endforeach
                    </div>
                    </div><!-- /.card-body -->
                  </div><!-- /.collapse -->
                      ...
                      <div class="card-body">
                        <div class="list-group">
                          @foreach($mathAs as $mathA)
                              <a href="{{route('question_select', $mathA->id)}}" class="list-group-item list-group-item-action">{{$mathA->name}}</a>
                          @endforeach
                      </div>
                      </div><!-- /.card-body -->
                    </div><!-- /.collapse -->
                      ...
                      <div class="card-body">
                        <div class="list-group">
                          @foreach($mathBs as $mathB)
                              <a href="{{route('question_select', $mathB->id)}}" class="list-group-item list-group-item-action">{{$mathB->name}}</a>
                          @endforeach
                      </div>
                      </div><!-- /.card-body -->
                    </div><!-- /.collapse -->
